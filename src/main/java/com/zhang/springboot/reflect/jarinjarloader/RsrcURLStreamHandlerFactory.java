        ...
        implements URLStreamHandlerFactory
{
    ...
    public RsrcURLStreamHandlerFactory(ClassLoader cl) { this.classLoader = cl; }
    ...
    public void setURLStreamHandlerFactory(URLStreamHandlerFactory fac) { this.chainFac = fac; }
}
