...
import com.zhang.springboot.collection.CollectionStreamTest;
import com.zhang.springboot.reflect.MyClassLoad;
...
public class JarRsrcLoader
{
    private static class ManifestInfo
    {
        ...
        ManifestInfo(ManifestInfo param1ManifestInfo) { this(); }
    }
    ...
    public static void main(String[] args) throws ClassNotFoundException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, SecurityException, NoSuchMethodException, IOException {
        ...
        //Class j = Class.forName("com.taobao.api.ApiException",true,jceClassLoader);
        //System.out.println(j);
//        jceClassLoader.loadClass()
        //Class c = Class.forName("com.zhang.springboot.reflect.jarinjarloader.LoadJarTest",true,jceClassLoader);
        Class c = jceClassLoader.loadClass("com.zhang.springboot.reflect.jarinjarloader.LoadJarTest");
        Method main = c.getMethod("main", new Class[] { args.getClass() });
        main.invoke(null, new Object[] { args });
        System.out.println(new CollectionStreamTest());
    }
